            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        $discountedPrice=0;
                        $display="block";
                            if($product->product_discount_type=='none'){
                                $display="none";
                            }
                        @endphp
                    ...
                    @elseif($product->product_stock <= 10)
                        <div class="alert alert-warning" role="alert">
                            <strong>Limited Stock!</strong> Only {{ $product->product_stock }} left in stock.
                        </div>
                    @else
                        <div class="alert alert-success" role="alert">
                            <strong>In Stock!</strong> Available for purchase.
                        </div>
                    @endif
                    <input type="hidden" name="product_id" value="{{ $product->id }}">
                    <input type="hidden" name="product_price" value="{{ $product->product_price }}">
                    @if($product->product_stock<=0)
                        <button type="button" class="btn btn-warning btn-lg mb-3 me-2" disabled>
