...
@section('content')
    ...
    <form class="dropzone dropzone-multiple p-0" id="dropzoneMultipleFileUpload" action="{{ route('admin.blog.store') }}"
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row flex-between-center">
                    <div class="col-md">
                        <h5 class="mb-2 mb-md-0">Add Blogs</h5>
                        @if (session('success'))
                        ...
                        <div class="row gx-2">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-control" name="status">
                                    <option value="active" {{ !empty($testimonial->status) && ($testimonial->status=='active') ? 'selected' : ''}}>Active</option>
                                    <option value="blocked" {{ !empty($testimonial->status) && ($testimonial->status=='blocked') ? 'selected' : ''}}>Blocked</option>
                                </select>
                            </div>
