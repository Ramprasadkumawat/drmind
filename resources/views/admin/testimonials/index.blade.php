...
<div class="card mb-3">
      <div class="card-body">
        <div class="row flex-between-center">
          <div class="col-md">
            <h5 class="mb-2 mb-md-0">View Testimonials</h5>
            @if(session('success'))
                      ...
                      <table class="table table-bordered table-striped fs-10 mb-0">
                        ...
                        <tbody class="list">
                          ...
                          <tr>
                            ...
                            <td class="email"><a href="{{ route('testimonials-page-with-url',['slug'=> $item->slug])}}" target="_blank">{{ route('testimonials-page-with-url',['slug'=> $item->slug])}}</a></td>
