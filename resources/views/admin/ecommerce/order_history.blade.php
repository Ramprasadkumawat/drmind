            ...
            <div class="row g-sm-4 g-3">
              <div class="col-xxl-4 col-md-6">
                <div class="prooduct-details-box">
                  <div class="d-flex"><img class="align-self-center img-fluid img-60" src="../assets/images/ecommerce/product-table-6.png" alt="#"/>
              ...
              <div class="col-xxl-4 col-md-6">
                <div class="prooduct-details-box">
                  <div class="d-flex"><img class="align-self-center img-fluid img-60" src="../assets/images/ecommerce/product-table-5.png" alt="#"/>
                    <div class="flex-grow-1">
                      <div class="product-name">
              ...
              <div class="col-xxl-4 col-md-6">
                <div class="prooduct-details-box">
                  <div class="d-flex"><img class="align-self-center img-fluid img-60" src="../assets/images/ecommerce/product-table-4.png" alt="#"/>
                    <div class="flex-grow-1">
                      <div class="product-name">
              ...
              <div class="col-xxl-4 col-md-6">
                <div class="prooduct-details-box">
                  <div class="d-flex"><img class="align-self-center img-fluid img-60" src="../assets/images/ecommerce/product-table-3.png" alt="#"/>
                    <div class="flex-grow-1">
                      <div class="product-name">
              ...
              <div class="col-xxl-4 col-md-6">
                <div class="prooduct-details-box">
                  <div class="d-flex"><img class="align-self-center img-fluid img-60" src="../assets/images/ecommerce/product-table-2.png" alt="#"/>
                    <div class="flex-grow-1">
                      <div class="product-name">
              ...
              <div class="col-xxl-4 col-md-6">
                <div class="prooduct-details-box">
                  <div class="d-flex"><img class="align-self-center img-fluid img-60" src="../assets/images/ecommerce/product-table-1.png" alt="#"/>
                    <div class="flex-grow-1">
                      <div class="product-name">
              ...
              <table class="table table-bordernone display" id="basic-1">
                <thead>
                  <tr>
                    ...
                    <th scope="col"><i class="fa-solid fa-angle-down"></i></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
