...
<div class="card mb-3">
      <div class="card-body">
        <div class="row flex-between-center">
          <div class="col-md">
            <h5 class="mb-2 mb-md-0">View All Subscription</h5>
            @if(session('success'))
                      ...
                      <table class="table table-bordered table-striped fs-10 mb-0">
                        <thead class="bg-200">
                          <tr>
                            ...
                            <th class="text-900 sort" data-sort="email">Product URL</th>
                            <th class="text-900 sort" data-sort="email">Name</th>
                            <th class="text-900 sort" data-sort="status">Price</th>
                            <th class="text-900 sort" data-sort="age">Category</th>
                            <th class="text-900 sort" data-sort="age">Status</th>
                            <th class="text-900 sort" data-sort="age">Date</th>
                        ...
                        <tbody class="list">
                          ...
                          <tr>
                            ...
                            <td class="name"><img src="{{ asset($item->productImages[0]->image_path); }}" width="80px" height="100px"></td>
                            <td class="name"><a href="{{ asset($item->e_pdf_url)}}" target="_blank">View</a></td>
                            <td class="email">{{ $item->product_name }}</td>
                           
                            <td class="status">{{ strtoupper($item->price_currency)."-".$item->monthly_price."/month" }}</td>
                            <td class="status">{{ $item->category->name }}</td>
                             <td class="status">{{ ucfirst($item->product_status) }}</td>
